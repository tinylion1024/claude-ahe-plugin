...
import { PostToolUseEventSchema } from '../types/index.js';
async function main() {
    ...
    try {
        ...
        const trace = manager.saveTrace(event.tool_name, event.tool_input, event.tool_output, event.execution_time_ms, undefined, // session_id (will be auto-generated)
        event.working_directory, config.collection.truncate_output_chars);
